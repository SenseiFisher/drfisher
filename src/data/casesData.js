    ...
    cases: [
      ...
      },
      {
        ...
        images: [
          ...
          { src: machshirCase4_2, alt: 'צילום לאחר הוצאת המכשיר השבור וביצוע טיפול שורש - מקרה 5', caption: 'צילום לאחר הוצאת המכשיר השבור וביצוע טיפול שורש' }
        ]
      },
      {
        title: 'מקרה 6',
      ...
      },
      {
        ...
        images: [
          ...
          { src: machshirCase3_2, alt: 'צילומי מעקב , שנתיים אחרי הוצאת המכשירים השבורים מהתעלות וביצוע חידוש טיפולי שורש - מקרה 8', caption: 'צילומי מעקב , שנתיים אחרי הוצאת המכשירים השבורים מהתעלות וביצוע חידוש טיפולי שורש' }
        ]
      }
    ]
  },
    ...
    cases: [
      {
        title: 'מקרה 1',
        images: [
          { src: ripuiCase7_3, alt: 'צילום אבחנתי נגע סביב שורש D - מקרה 1', caption: 'צילום אבחנתי נגע סביב שורש D' },
          { src: ripuiCase2_2, alt: 'צילום ביקורת - מקרה 1', caption: 'צילום ביקורת', description: '9 חודשים לאחר מיכן רואים ריפוי של הנגע' }
        ]
      },
      {
        title: 'מקרה 2',
      ...
      },
      {
        title: 'מקרה 3',
        images: [
          { src: ripuiCase3_2, alt: 'צילום אבחנתי - מקרה 3', caption: 'צילום אבחנתי', description: 'נגע סביב שורש M' },
          { src: ripuiCase1_2, alt: 'צילום ביקורת - מקרה 3', caption: 'צילום ביקורת', description: 'שנה ושלושה חודשים לאחר מיכן רואים ריפוי של הנגע' }
        ]
      },
      {
        title: 'מקרה 4',
        images: [
          { src: ripuiCase7_1, alt: 'צילום אבחנתי - מקרה 4', caption: 'צילום אבחנתי (עם גוטה פרקה דרך הסינוס טראקט)', description: 'נגע גדול הכולל את קצות השורשים ואזור המסעף הבין שורשי' },
          { src: ripuiCase6_3, alt: 'צילום ביקורת - מקרה 4', caption: 'צילום ביקורת', description: '3 שנים לאחר מיכן רואים ריפוי של הנגע' }
        ]
      },
      {
        title: 'מקרה 5',
        images: [
          { src: ripuiCase2_1, alt: 'צילום אבחנתי - מקרה 5', caption: 'צילום אבחנתי', description: 'נגע הכולל את קצות השורשים' },
          { src: ripuiCase3_1, alt: 'צילום ביקורת - מקרה 5', caption: 'צילום ביקורת', description: '7 חודשים לאחר מיכן רואים ריפוי של הנגע' }
        ]
      },
      {
        title: 'מקרה 6',
        images: [
          { src: ripuiCase4_2, alt: 'צילום אבחנתי - מקרה 6', caption: 'צילום אבחנתי', description: 'נגע סב-שורשי גדול' },
          { src: ripuiCase6_1, alt: 'צילום בסיום הטיפול - מקרה 6', caption: 'צילום בסיום הטיפול' },
          { src: ripuiCase6_2, alt: 'שנתיים לאחר מיכן - מקרה 6', caption: 'שנתיים לאחר מיכן רואים ריפוי חלקי משמעותי של הנגע' }
        ]
      },
      {
        title: 'מקרה 7',
